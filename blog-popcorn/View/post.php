    ...
    <div class="container">
        ...
        <?php else: ?>
            ...
            <?php if(empty($_SESSION['is_user']) && empty($_SESSION['is_admin'])): ?>
                <a href="<?=ROOT_URL?>?p=blog&amp;a=login"><button class="btn red waves-effect waves-light">Se connecter pour commenter</button></a>
                <br><br>
            <?php else: ?>
                <h4>Commenter :</h4>
                ...
                <form method="post">
                    <div class="row">
                        ...
                        <div class="col s12">
                            <button type="submit" name="submit_comment" class="btn red waves-effect waves-light">
                                Commenter
                            </button>
                        </div>
                    </div>
