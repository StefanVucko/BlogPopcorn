        ...
        <div class="col l6 m12 s12">
          <div class="card hoverable">
            <div class="card-content">
              <h5><a class="grey-text text-darken-4" href="<?=ROOT_URL?>blog_post_<?=$oPost->id?>.html"><?=htmlspecialchars($oPost->title)?></a></h5>
            ...
            <div class="card-content">
              ...
              <p><a class="red-text text-darken-4" href="<?=ROOT_URL?>blog_post_<?=$oPost->id?>.html">Voir l'article</a></p>
            </div>
